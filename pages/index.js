                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className="order-2 lg:order-1">
                            <span className="text-indigo-400 font-semibold tracking-wider uppercase text-sm">Autor Destacado</span>
                            <h2 className="text-4xl font-extrabold mt-2 mb-6 text-white">Delfino Rene Garcia Vazquez</h2>
                            <p className="text-slate-300 text-lg mb-6 leading-relaxed">
                                Maestro de la fantasía épica contemporánea. Con su aclamada saga <strong>"La Espada de la Luz"</strong>, 
                                Delfino ha cautivado a miles de lectores sumergiéndolos en una batalla ancestral entre ángeles y demonios, 
                                donde la humanidad es el campo de batalla y la última esperanza de redención.
                            </p>
                            <p className="text-slate-400 mb-8">
                                Sus obras, "El Libro de la Noche" y "Resurrección", destacan por su rica mitología, personajes complejos y 
                                una narrativa vibrante que no da tregua desde la primera página. Descubre el universo que ha redefinido 
                                la fantasía hispana.
                            </p>
                            <div className="flex gap-4">
                                <a href="#catalogo" className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-slate-900 bg-white hover:bg-slate-100 transition-colors">
                                    Ver sus obras
                                </a>
                            </div>
                        </div>
